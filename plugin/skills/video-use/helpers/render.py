...
# MarginV=90 lands caption baseline ~30% up from bottom on any aspect — clear of social UI.
SUB_FORCE_STYLE = (
...
def main() -> None:
    ...
    segment_paths = extract_all_segments(edl, edit_dir, preview=args.preview, draft=args.draft)
